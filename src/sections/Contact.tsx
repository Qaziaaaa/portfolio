...
const Contact = () => {
  ...
  const headlineWords = ["Open", 'to', 'Opportunities'];
  ...
  return (
    ...
    >
      ...
      <div className="contact-bg absolute inset-0 opacity-0 hidden lg:block">
        <div
      ...
      <div className="relative z-10 w-[95%] max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* Headline */}
        <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-medium text-white leading-tight tracking-tight mb-3">
        ...
        <div className="contact-cta mb-8 gap-3 sm:gap-4 flex flex-col sm:flex-row justify-center items-center px-4 sm:px-0">
          <a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-6 sm:px-8 py-3.5 sm:py-4 bg-white text-black font-medium rounded-full lg:hover:scale-105 transition-all duration-300 group text-sm sm:text-base"
          >
            Connect on LinkedIn
            <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 lg:group-hover:translate-x-1 transition-transform" />
          </a>
          <a
            href="https://wa.me/923141935787"
            target="_blank"
            rel="noopener noreferrer"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-6 sm:px-8 py-3.5 sm:py-4 border border-white/20 text-white font-medium rounded-full lg:hover:bg-white/10 transition-all duration-300 group text-sm sm:text-base"
          >
            WhatsApp Me
            <svg className="w-4 h-4 sm:w-5 sm:h-5 lg:group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="contact-email px-2 sm:px-0">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-start sm:items-center gap-2 sm:gap-3 text-white/80 lg:hover:text-white transition-colors group max-w-full text-left sm:text-center"
          >
            ...
            <span className="relative text-sm sm:text-base leading-snug">
              ...
              <span className="absolute -bottom-1 left-1/2 sm:left-1/2 w-0 h-[1px] bg-white transition-all duration-300 lg:group-hover:w-full lg:group-hover:left-0" />
            </span>
          </a>
        </div>
      </div>
